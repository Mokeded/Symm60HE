...
| `Symm60HE_Project.pretty/AM1_SOIC-16…` | replaces FN40HE's `AM1_TSSOP-16…`, which is not vendored here | **not** copied. Same chip, SN74LV4051A**D** instead of ...**APWR**: TSSOP's 0.65 mm pitch leaves 0.25 mm between pads, which no trace clears, so every interior mux pin was unroutable. SOIC's 1.27 mm pitch leaves 0.67 mm |
