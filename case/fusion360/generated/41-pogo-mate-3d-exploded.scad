...
color([0.12,0.44,0.55,1.0]) translate([-0.2645,0.6096,4.9557]) import("/home/user/Symm60HE/case/fusion360/generated/CaseRef-LeftTargetConnector.stl");
...
color([0.05,0.34,0.18,0.90]) translate([-0.2645,0.6096,4.9557]) intersection() {
