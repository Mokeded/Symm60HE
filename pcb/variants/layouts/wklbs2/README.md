# Symm60HE wklbs2 layout-specific PCB pair
...
- Left active Hall positions: 30
- Right active Hall positions: 29
- Left bottom row: wkl
- Right bottom row: wkl
- Backspace: 2u
- Removed left RGB footprints: DL33
- Removed right RGB footprints: DR22, DR34, DR36, DR4, DR5
